...
def assert_public_demo_source_contract() -> None:
    ...
    required_main = {
        ...
        "empty workspace entry": "화면을 여는 것만으로는 세션이나 기록이 생성되지 않습니다.",
        "explicit new-session control": 'id="workspace-new-session"',
        "non-automatic consultation entry": '$("guided-demo").addEventListener("click",()=>{',
    }
    required_theme = {
    ...
    required_detail = {
        ...
        "visible workflow grid": '#service-intro-section + .feature-grid{position:relative!important;z-index:9;display:grid!important',
